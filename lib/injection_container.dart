...
import 'package:sendme/data/datasource/firebase_remote_datasource.dart';
import 'package:sendme/data/datasource/firebase_remote_datasource_impl.dart';
import 'package:sendme/data/local_datasource/local_datasource.dart';
import 'package:sendme/data/repositories/firebase_repository_impl.dart';
import 'package:sendme/data/repositories/get_device_number_repository_impl.dart';
...
import 'package:sendme/domain/usecases/create_one_to_one_chat_channel_usecase.dart';
import 'package:sendme/domain/usecases/get_all_user_usecase.dart';
import 'package:sendme/domain/usecases/get_create_current_user_usecase.dart';
import 'package:sendme/domain/usecases/get_current_uid_usecase.dart';
import 'package:sendme/domain/usecases/get_device_numbes_usecase.dart';
import 'package:sendme/domain/usecases/get_my_chat_usecase.dart';
...
import 'package:sendme/domain/usecases/is_sign_in_usecase.dart';
import 'package:sendme/domain/usecases/send_text_message_usecase.dart';
import 'package:sendme/domain/usecases/sign_in_with_phone_number_usecase.dart';
import 'package:sendme/domain/usecases/sign_out_usecase.dart';
import 'package:sendme/domain/usecases/verify_phone_number_usecase.dart';
...
//useCase
  sl.registerLazySingleton<GetCreateCurrentUseCase>(
      () => GetCreateCurrentUseCase(repository: sl.call()));
